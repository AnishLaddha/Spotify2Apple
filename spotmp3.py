...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title_label.setText("Spotify2MP3")
        self.title_label.setObjectName("title_label")
        self.enter_playlist_url_label = QtWidgets.QLabel(self.centralwidget)
        self.enter_playlist_url_label.setGeometry(QtCore.QRect(140, 388, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.url_input.setGeometry(QtCore.QRect(140, 409, 550, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.url_load_button.setGeometry(QtCore.QRect(40, 408, 90, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.url_error_label.setGeometry(QtCore.QRect(525, 390, 170, 16))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.download_button.setGeometry(QtCore.QRect(40, 530, 110, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.download_button.setFont(font)
        self.download_button.setObjectName("download_button")
        self.download_path = QtWidgets.QPushButton(self.centralwidget)
        self.download_path.setGeometry(QtCore.QRect(40, 467, 90, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.download_folder_select.setGeometry(QtCore.QRect(140, 471, 430, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.cancel_button.setGeometry(QtCore.QRect(160, 530, 110, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.cancel_button.setFont(font)
        self.cancel_button.setObjectName("cancel_button")
        self.download_folder_label = QtWidgets.QLabel(self.centralwidget)
        self.download_folder_label.setGeometry(QtCore.QRect(140, 450, 151, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.itunes_annotate.setGeometry(QtCore.QRect(40, 350, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.revert_annotate.setGeometry(QtCore.QRect(40, 350, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.download_status.setGeometry(QtCore.QRect(290, 510, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.credit_url.setGeometry(QtCore.QRect(560, 30, 80, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.itunes_annotate.setText(_translate("MainWindow", "Add Metadata"))
